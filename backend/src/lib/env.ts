...
const rawEnvSchema = z.object({
  ...
  ADMIN_SUPER_EMAILS: z.string().default('mirajsk2000@gmail.com'),
...
const rawEnv = rawEnvSchema.parse({
  ...
  RAZORPAY_KEY_ID: readTrimmedEnv('RAZORPAY_KEY_ID'),
  RAZORPAY_KEY_SECRET: readTrimmedEnv('RAZORPAY_KEY_SECRET'),
  ADMIN_SUPER_EMAILS: readTrimmedEnv('ADMIN_SUPER_EMAILS'),
