      ...
      >
        {visibleQuestions.map((question, idx) => (
          <View
            ...
            className="mb-5"
          >
            <Text className="text-[21px] font-semibold text-gray-800 mb-2">
              {idx + 1}. {question}
              {showErrors &&
...
>
  ...
  <View className="items-center justify-between h-[128px]">
    {/* Emoji */}
    <Animated.View
      style={{
    ...
    <View className="h-[32px] justify-center">
      <Text className="text-[14px] text-center text-gray-700 font-medium leading-4">
        {option.label}
      </Text>
    </View>

    {/* Tick (no background change) */}
