        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            ...
            <View className="mt-[30px] bg-[rgba(0,0,0,0.35)] p-[18px] rounded-[20px]">
              <Text className="text-white text-[16px] font-bold mb-2.5">What This App Does NOT Do</Text>
  ...
  return (
    ...
    >
      <View style={{ flex: 1 }}>
        ...
        <Text className="text-[#cfe8ff] mt-1.5 text-[13px] leading-[18px] w-[95%]">
          {desc}
        </Text>
      </View>
...
function InfoRow({ text }: { text: string }) {
  return (
    <View className="flex-row items-center mb-1.5">
      <Text className="text-[#ff5c5c] text-[16px] mr-2">x</Text>
